(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["curveJsSdk"] = factory();
	else
		root["curveJsSdk"] = factory();
})(this, function() {
 ...
 * @public
 */
class CurveError extends Error {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.WITH_MINI_PROGRAM = void 0;
exports.WITH_MINI_PROGRAM = Boolean(typeof wx !== 'undefined' && wx.request); // auto detect current environment and differentiate web from mini program
exports.default = {
    HOST: 'http://localhost:4000',
    APP_ID: '',
    WITH_MINI_PROGRAM: // WeChat miniprogram app id
    exports.WITH_MINI_PROGRAM,
    SILENT_LOGIN: false,
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const request_1 = __webpack_require__(26);
const constants_1 = __webpack_require__(3);
const { ROUTES } = constants_1.default;
/**
 * Create API calls
    ...
    return Object.keys(ROUTES).reduce((final, key) => {
        ...
        for (const subKey in ROUTES[key]) {
            ...
            final[key][subKey] = ({ params = {}, data = {} } = {}) => {
                return request_1.default[apiMethod](url, { data, params });
            };
        }
        return final;
    }, {});
};
exports.default = createAPICalls();
...
class User {
    ...
    static login({ username, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield api_1.default.user.login({ data: { username, password } });
                const { token, user: _userInfo } = result;
                storage_1.default.set(constants_1.default.USER_INFO, _userInfo);
                storage_1.default.set(constants_1.default.AUTH_TOKEN, token);
                return result;
            }
            catch (error) {
                return null;
    ...
    static register({ username, password, email, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.user.register({ data: { username, password, email } });
        });
    }
    /**
     ...
     * @returns response from server
     */
    static changePassword({ username, password, email, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.user.changePassword({
    ...
    static checkToken() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.user.checkToken();
        });
    }
    /**
     ...
     */
    static signInWithWeChat(userInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!config_1.WITH_MINI_PROGRAM) {
                console.error('Unable to sign in with WeChat. Make sure your app is in WeChat environment.');
                return;
            }
            if (userInfo) {
                const _userInfo = yield updateWeChatUserInfo(userInfo);
                storage_1.default.set(constants_1.default.USER_INFO, _userInfo);
                return _userInfo;
            }
            else {
                const { token, user: _userInfo, expiredAt } = yield silentLogin();
                storage_1.default.set(constants_1.default.USER_INFO, _userInfo);
                storage_1.default.set(constants_1.default.AUTH_TOKEN, token);
                storage_1.default.set(constants_1.default.TOKEN_EXPIRED_AT, expiredAt);
                return { token, user: _userInfo };
            }
        });
    }
    static signOut() {
        storage_1.default.clear(constants_1.default.USER_INFO);
        storage_1.default.clear(constants_1.default.AUTH_TOKEN);
        storage_1.default.clear(constants_1.default.TOKEN_EXPIRED_AT);
    }
}
    ...
    return new Promise((resolve, reject) => {
        wx.login({
            success: (res) => __awaiter(void 0, void 0, void 0, function* () {
                if (res.code) {
                    const response = yield api_1.default.user.signInWithWeChat({
                        data: { code: res.code },
                    });
                    resolve(response);
                }
 ...
 * @param userInfo
 */
const updateWeChatUserInfo = (userInfo) => __awaiter(void 0, void 0, void 0, function* () {
    return yield api_1.default.user.updateWeChatUserInfo({ data: { userInfo } });
});
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.checkToken = exports.getAuthToken = void 0;
const storage_1 = __webpack_require__(4);
const constants_1 = __webpack_require__(3);
/**
 * Get auth token
 */
const getAuthToken = () => {
    const token = storage_1.default.get(constants_1.default.AUTH_TOKEN);
    if (!token)
        return null;
    return 'bearer ' + token;
};
 ...
 */
const checkToken = () => {
    const tokenExpiredAt = storage_1.default.get(constants_1.default.TOKEN_EXPIRED_AT);
 ...
 */
class Document {
    constructor(collection, documentId, where) {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.collection.create({
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.documentId) {
                throw new error_1.default(601);
            }
            return yield api_1.default.collection.update({
                params: {
    ...
    updateMany() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.collection.updateMany({
                params: { collection: this.collection },
                data: {
                    where: this.where,
                    data: this.document,
 ...
 */
class Query {
    constructor(pageSize = 20, pageNo = 1, exclude = [], order = -1, where = {}, populate = [], distinct = '') {
    ...
    setPopulate(populate) {
        if (Object.prototype.toString.call(populate) !== '[object Object]' &&
            !Array.isArray(populate)) {
            throw new error_1.default(600);
        }
...
const collection_1 = __webpack_require__(59);
const document_1 = __webpack_require__(23);
const query_1 = __webpack_require__(24);
const where_1 = __webpack_require__(60);
const storage_1 = __webpack_require__(4);
const error_1 = __webpack_require__(1);
/**
 * Define BaaS
 */
const BaaS = {
    init: ({ host = config_1.default.HOST, appid = '', silentLogin = false, } = {}) => {
        config_1.default.HOST = host;
        config_1.default.APP_ID = appid;
        config_1.default.SILENT_LOGIN = silentLogin;
        if (config_1.default.WITH_MINI_PROGRAM && !appid) {
            throw new error_1.default(601, 'You must provide an app id when using this SDK in WeChat Mini Program.');
        }
    },
 ...
 */
if (config_1.default.WITH_MINI_PROGRAM) {
    wx.BaaS = BaaS;
}
exports.default = BaaS;
...
Object.defineProperty(exports, "__esModule", { value: true });
const interceptor_1 = __webpack_require__(27);
const config_1 = __webpack_require__(2);
...
const send = ({ url, method, params, data }) => {
    ...
    return new Promise((resolve, reject) => {
        interceptor_1.default({
            url: config_1.default.HOST + format(url, params),
            method,
            [body]: data,
        })
...
const sendViaMiniProgram = ({ url, method, params, data }) => {
    if (config_1.default.WITH_MINI_PROGRAM && !config_1.default.APP_ID) {
        throw new error_1.default(601, 'Required WeChat app id is missing.');
    }
    const isTokenExpired = common_1.checkToken(); // check if token is expired
    let interceptor;
    if (config_1.default.SILENT_LOGIN && isTokenExpired && !silentLoginInProgress) {
        silentLoginInProgress = true;
        interceptor = user_1.default.signInWithWeChat();
    }
    else {
    ...
    return interceptor.then(() => {
        return new Promise((resolve, reject) => {
            const token = common_1.getAuthToken();
            const header = token
                ? { appid: config_1.default.APP_ID, Authorization: token }
...
const request = () => {
    ...
    const requestObj = methods.reduce((result, method) => {
        result[method] = (url, { params = {}, data = {} }) => {
            const paramsToSend = {
                url,
                method: constants_1.default.METHOD_TYPE[method.toUpperCase()],
                params,
                data,
            };
            if (config_1.default.WITH_MINI_PROGRAM) {
...
var buildURL = __webpack_require__(6);
var buildFullPath = __webpack_require__(14);
...
const tty = __webpack_require__(49);
 ...
 * @public
 */
class Collection extends query_1.default {
    ...
    getWithoutData(documentId) {
        if (documentId) {
            return new document_1.default(this.collection, documentId);
        }
        else {
            return new document_1.default(this.collection, null, this.where);
        }
    }
    /**
     ...
     */
    create() {
        return new document_1.default(this.collection);
    }
    /**
    ...
    createMany(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.createMany({
                params: { collection: this.collection },
                data,
            });
        });
    ...
    find(documentId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.collection.find({
                params: {
                    collection: this.collection,
                    documentId,
                },
    ...
    findMany() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.findMany({
                params: { collection: this.collection },
                data,
            });
        });
    ...
    findDistinct() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.findDistinct({
                params: { collection: this.collection },
                data,
            });
        });
    ...
    remove(documentId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.collection.remove({
    ...
    removeMany() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield api_1.default.collection.removeMany({
                params: { collection: this.collection },
                data: {
                    where: this.where,
                },
    ...
    count() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.count({
                params: { collection: this.collection },
                data,
            });
        });
    ...
    sum(field) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.sum({
                params: { collection: this.collection },
                data: {
                    where: this.where,
                    field,
    ...
    random(size) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield api_1.default.collection.random({
                params: { collection: this.collection },
                data,
            });
        });
 ...
 */
const getOrWhere = (operator, whereArray, whereClass) => {
